...
import { Stethoscope, User, FileText, Mail, MapPin, Calendar, ChevronRight, CheckCircle, Upload, Briefcase } from 'lucide-react-native';
  ...
  const handleSkip = async () => {
    ...
    try {
      const registrationData = {
        ...
        yearsOfExperience: professionalInfo.yearsOfExperience ? parseInt(professionalInfo.yearsOfExperience) : undefined,
      ...
      const response = await authFlowService.registerDoctor(phone as string, registrationData);
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setProfessionalInfo({ ...professionalInfo, specialization: text })}
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setProfessionalInfo({ ...professionalInfo, registrationNumber: text })}
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setProfessionalInfo({ ...professionalInfo, yearsOfExperience: text })}
            placeholder="e.g., 10"
            placeholderTextColor="#94a3b8"
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setProfessionalInfo({ ...professionalInfo, qualification: text })}
      ...
      <View style={styles.inputGroup}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            ...
            onChangeText={(text) => setProfessionalInfo({ ...professionalInfo, hospitalAffiliation: text })}
    ...
    >
      ...
      {selectedDocuments.length > 0 && (
        <View style={styles.uploadedSection}>
          <Text style={styles.uploadedTitle}>Uploaded Documents ({selectedDocuments.length})</Text>
      ...
      <View style={styles.skipNotice}>
        <Text style={styles.skipNoticeText}>
          You can skip document upload and complete it later from your profile settings.
        </Text>
      </View>
    </MotiView>
  );
            ...
            <View style={styles.buttonContainer}>
              ...
              {currentStep > 1 && (
                ...
                >
                  {loading ? (
                    ...
                    <Text style={styles.secondaryButtonText}>Skip & Finish</Text>
                  )}
                </TouchableOpacity>
              )}
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  ((currentStep === 1 && !isStep1Valid) || loading) && styles.buttonDisabled,
                ]}
              >
                <LinearGradient
                  colors={((currentStep === 1 && !isStep1Valid) || loading) ? ['#334155', '#1e293b'] : ['#10b981', '#059669']}
